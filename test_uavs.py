...
def startTimer():
    ...
    for i in range(1,len(targets)+1):
        ...
        if (i % 2) == 0:
            cmd = '/usr/bin/coresendmsg -a 172.16.0.254 NODE NUMBER='+str(targets[i-1])+' X_POSITION='+str(xuav+200)+' Y_POSITION='+str(yuav+(i/2-1)*150)
        else:
            cmd = '/usr/bin/coresendmsg -a 172.16.0.254 NODE NUMBER='+str(targets[i-1])+' X_POSITION='+str(xuav)+' Y_POSITION='+str(yuav+((i-1)/2)*150)
...
def stopTimer():
    ...
    for i in range(1,len(targets)+1):
        ...
        if (i % 2) == 0:
            cmd = '/usr/bin/coresendmsg -a 172.16.0.254 NODE NUMBER='+str(targets[i-1])+' X_POSITION='+str(xuav+100)+' Y_POSITION='+str(yuav+(i/2-1)*100)
        else:
            cmd = '/usr/bin/coresendmsg -a 172.16.0.254 NODE NUMBER='+str(targets[i-1])+' X_POSITION='+str(xuav)+' Y_POSITION='+str(yuav+((i-1)/2)*100)
